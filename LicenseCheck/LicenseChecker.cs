...
namespace LicenseCheck
{
    ...
    public class LicenseChecker
    {
        ...
        private static string[] SUFFIXES_LICENSE = {
            // Apache
            "projects from the command-line or the IDE. Copyright (C) Microsoft Corporation. Apache 2.0 License.",

            // ???
            "projects from the command-line or the IDE. Copyright (C) Microsoft Corporation. All rights reserved.",
            "projects from the command-line or the IDE. Copyright (c) .NET Foundation. All rights reserved.",
            "specific build process. Copyright (C) Microsoft Corporation. All rights reserved.",
            "which is imported by this file. Copyright (C) Microsoft Corporation. All rights reserved.",
        };

        private static string[] LICENSES = {
            "{0} WARNING: DO NOT MODIFY this file unless you are knowledgeable about MSBuild and have created a backup copy. Incorrect changes to this file will make it impossible to load or build your projects from the command-line or the IDE. This file defines the steps in the standard build process for .NET projects. It contains all the steps that are common among the different .NET languages, such as Visual Basic, and Visual C#. Copyright (C) Microsoft Corporation. All rights reserved.",
        ...
        private static string[] PREFIXES_NOT_LICENSE =
        {
            ...
            "From Dev12 on we want the versioning",
            "Regression",
            "TEST SUITE FOR ",
        ...
        private static string[] NOT_LICENSES =
        {
            ...
            "Asserts",
            "Timings",
            "With MSBuild 12, we've changed MSBuildToolsPath to for the first time point to a directory outside of the .NET Framework. As a result of this, there were several targets files, of which this was one, that were being referenced as out of MSBuildToolsPath that are now no longer there. Thus, we are shimming those targets files so that they do still appear in MSBuildToolsPath, so that consumers of them are not broken, but since the targets files themselves are still part of .NET, the shim will internally simply redirect to the real copy of the targets file in the .NET Framework.",
        };
        ...
        public LicenseCheckResult Check(FilePath file, FileType fileType, string licenseHeader)
        {
            ...
            found = found || SUFFIXES_LICENSE.Any(
                license => licenseHeader.EndsWith(string.Format(license, filename))
            );
